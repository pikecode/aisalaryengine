  ...
  <div class="min-h-screen flex flex-col bg-white">
    ...
    <div class="flex items-center justify-between px-4 py-4 border-b border-gray-100">
      <div class="flex items-center gap-3">
        ...
        <h1 style="font-family:'Source Han Sans CN',sans-serif;font-weight:500;font-size:18px;color:#393939;">消息</h1>
      </div>
    ...
    <div class="px-4 py-3">
      <div class="relative">
        <input
          type="text"
          placeholder="搜索消息"
          class="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-none rounded-lg outline-none"
    ...
    <!-- Tab -->
    <div class="px-4 flex gap-6 border-b border-gray-100">
      <button
        v-for="tab in tabs"
        :key="tab.id"
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center justify-between mb-1">
              <span style="font-family:'Source Han Sans CN',sans-serif;font-weight:500;font-size:15px;color:#393939;">{{ msg.title }}</span>
...
const messages = [
  ...
  { id: 5, title: '活动提醒', content: '本周五有新的AI创业分享活动，欢迎参加', time: '3天前', unread: 0, avatarBg: '#FF6B6B', avatarText: '活' }
]
