  ...
  <div class="min-h-screen flex flex-col mobile-login-bg">
    ...
    <div class="px-5">
      ...
      <div class="flex gap-6 mb-5">
        <button
          :class="['transition-all pb-1', loginType === 'password' ? 'border-b-2 border-gray-900' : '']"
          :style="loginType === 'password'
            ? 'font-family:\'PingFang SC\',sans-serif;font-weight:bold;font-size:16px;color:#333333;line-height:27px;text-align:left;'
            : 'font-family:\'PingFang SC\',sans-serif;font-weight:normal;font-size:16px;color:#999999;line-height:27px;text-align:left;'"
          @click="loginType = 'password'"
        >
          密码登录
        </button>
        <button
          :class="['transition-all pb-1', loginType === 'code' ? 'border-b-2 border-gray-900' : '']"
          :style="loginType === 'code'
            ? 'font-family:\'PingFang SC\',sans-serif;font-weight:bold;font-size:16px;color:#333333;line-height:27px;text-align:left;'
            : 'font-family:\'PingFang SC\',sans-serif;font-weight:normal;font-size:16px;color:#999999;line-height:27px;text-align:left;'"
      ...
      <!-- Forgot Password -->
      <div class="mb-4">
        <RouterLink to="/forgot-password" style="font-family:'Inter',Inter;font-weight:400;font-size:14px;color:#1427FF;">
          忘记密码
        </RouterLink>
      </div>
    </div>
    ...
    <div class="px-5 pb-10">
      ...
      <div class="text-center mt-5">
        <RouterLink to="/register" style="font-family:'Source Han Sans CN',sans-serif;font-weight:400;font-size:14px;color:#393939;">
          会员注册
        </RouterLink>
      </div>
    </div>
