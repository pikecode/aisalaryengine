        ...
        <div class="space-y-8">
          ...
          <div class="space-y-4 pt-4">
            <div class="flex items-center gap-3">
              ...
              <span class="text-lg">1000+ 精选AI项目库</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span class="text-lg">专业AI创业社群</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span class="text-lg">实时项目更新推送</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full md:w-[600px] flex-shrink-0 bg-white flex items-center justify-center px-8 py-12">
      <div class="w-full max-w-md">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <button
            type="submit"
            class="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl btn-mobile"
          >
            立即注册
          </button>
        </form>
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white text-gray-500">或使用第三方账号注册</span>
          </div>
        </div>

        <!-- Social Login -->
        <div class="grid grid-cols-3 gap-3">
          <button class="flex items-center justify-center py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors btn-mobile">
          ...
          <button class="flex items-center justify-center py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors btn-mobile">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="#09B83E">
              <path d="M81 2.188C7.099 2.188 5.785 3.515 5.785 5.12c0 1.606 1.314 2.933 2.906 2.933s2.906-1.327 2.906-2.933c0-1.605-1.314-2.932-2.906-2.932zm11.618 0C18.717 2.188 17.403 3.515 17.403 5.12c0 1.606 1.314 2.933 2.906 2.933s2.906-1.327 2.906-2.933c0-1.605-1.314-2.932-2.906-2.932zM8.691 8.053c-1.592 0-2.906 1.327-2.906 2.933 0 1.605 1.314 2.932 2.906 2.932s2.906-1.327 2.906-2.932c0-1.606-1.314-2.933-2.906-2.933zm11.618 0c-1.592 0-2.906 1.327-2.906 2.933 0 1.605 1.314 2.932 2.906 2.932s2.906-1.327 2.906-2.932c0-1.606-1.314-2.933-2.906-2.933zM8.691 13.918c-1.592 0-2.906 1.327-2.906 2.933 0 1.605 1.314 2.932 2.906 2.932s2.906-1.327 2.906-2.932c0-1.606-1.314-2.933-2.906-2.933zm11.618 0c-1.592 0-2.906 1.327-2.906 2.933 0 1.605 1.314 2.932 2.906 2.932s2.906-1.327 2.906-2.932c0-1.606-1.314-2.933-2.906-2.933z"/>
            </svg>
          </button>
          <button class="flex items-center justify-center py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors btn-mobile">
        ...
        <div class="text-center mt-6">
          ...
          <RouterLink to="/login" class="text-blue-600 hover:underline text-sm font-medium ml-1">
            立即登录
          </RouterLink>
        </div>
        </div>
