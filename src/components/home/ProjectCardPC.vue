<template>
    ...
    <div class="flex flex-row items-start gap-6 h-full">
      ...
      <div class="flex-1">
        <div class="flex items-start gap-3 mb-3">
          <!-- Cost Badge -->
          <span class="inline-flex flex-col items-center justify-center px-3 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white flex-shrink-0">
  ...
  >
    ...
    <div class="flex items-start gap-3 mb-3">
      <!-- Cost Badge -->
      <span class="inline-flex flex-col items-center justify-center px-2.5 py-1.5 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white flex-shrink-0">
    ...
    <div class="flex items-center justify-between pt-4 border-t border-gray-200">
      ...
      <button class="px-4 py-2 rounded-lg bg-white border border-gray-900 text-gray-900 text-sm font-medium hover:bg-gray-50 transition-colors whitespace-nowrap">
        立即上车
      </button>
    </div>
  </div>
